...
struct PenDiagramView: View {
    ...
    private static let bodyPath   = Path(svgData:
    ...
    private static let eraserPath = Path(svgData:
    ...
    private static let tipPath    = Path(svgData:
