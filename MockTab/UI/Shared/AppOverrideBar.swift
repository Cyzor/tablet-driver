...
struct AppOverrideBar: View {
    ...
    static let buttonKeys: Set<String> = [
        ...
        "expressKeyBindings",
        "touchRingButtonBinding", "touchRingButtonBinding2",
        "touchRingSlotsJSON", "touchRingActiveSlotIndex", "touchRingActiveSlotIndex2", "reverseRingDirection",
        "rotariesJSON",
    ]
    ...
    private var chipRow: some View {
        HStack(spacing: 5) {
            ...
            ForEach(settings.appOverrides) { override in
                ...
                .modifier(ChipCollapsedDragSource(
        ...
        .animation(
            ...
            value: ChipDragHoverState(targetID: dragHoverTargetID, atEnd: dragHoverAtEnd)
        )
        .animation(
