...
**Collect Device Data** records what the tablet sends while you use it. The result is a single zip file you can attach to a request to add or improve support for a device.
